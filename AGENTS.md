...
This file provides guidance to AI coding agents (Codex, Claude Code, and similar tools) when working
with code in this repository. Kept in sync with `CLAUDE.md` — the two should always say the same thing.
